...
совместимости
* Добавлен таймаут для модуля *weather* в 3 секунды, чтобы не тормозить обновление остального 
контента, в случае, если погоду невозможно получить в течении этого времени
* Добавлена загрузка пропущенного Perl модуля *IO::Socket::SSL*, из-за котого не работал 
модуль *imap*
...
### 2.00 Beta 11
* Модуль Gmail заменён на модуль IMAP, который может получать количество непрочитанных сообщений с 
